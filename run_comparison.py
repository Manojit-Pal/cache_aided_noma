...
# usage: run_comparison.py [-h] [--quick] [--full] [--snr-min SNR_MIN]
#                          [--snr-max SNR_MAX] [--snr-step SNR_STEP] [--no-dqn]
#                          [--policies {topk,lru,lfu,random,none,dqn} [...]]
#                          [--num-realizations NUM_REALIZATIONS]
#                          [--output-dir OUTPUT_DIR]
#                          [--config {default,aggressive,conservative}]
#                          [--seed SEED] [--verbose]

# Run Cache-Aided NOMA Comparative Analysis

# optional arguments:
#   -h, --help            show this help message and exit
#   --quick               Quick test mode (100 episodes, 10 runs, ~10-15 min)
#   --full                Full experiment mode (2000 episodes, 100 runs, ~2-3 hours)
#   --snr-min SNR_MIN     Minimum SNR in dB (default: -10)
#   --snr-max SNR_MAX     Maximum SNR in dB (default: 30)
#   --snr-step SNR_STEP   SNR step size in dB (default: 2)
#   --no-dqn              Skip DQN policy (useful for quick baseline comparison)
#   --policies {topk,lru,lfu,random,none,dqn} [...]
#                         Specify which policies to evaluate (default: all)
#   --num-realizations NUM_REALIZATIONS
#                         Number of Monte Carlo realizations per SNR point (default: 1000)
#   --output-dir OUTPUT_DIR
#                         Output directory for results (default: results)
#   --config {default,aggressive,conservative}
#                         DQN learning configuration preset (default: default)
